	...
	theme: {
		...
		extend: {
			...
			animation: {
				...
				'scale-bounce': 'scale-bounce 0.8s cubic-bezier(0.34, 1.56, 0.64, 1)',
				'rotate-in': 'rotate-in 0.7s cubic-bezier(0.16, 1, 0.3, 1)',
				'blur-focus': 'blur-focus 1s cubic-bezier(0.16, 1, 0.3, 1)',
				'elastic-bounce': 'elastic-bounce 1.2s cubic-bezier(0.68, -0.55, 0.265, 1.55)',
