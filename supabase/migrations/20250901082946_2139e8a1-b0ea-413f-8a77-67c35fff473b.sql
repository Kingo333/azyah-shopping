...
-- Fix 3: Enhanced Access Logging for Contact Data
-- ===============================================

CREATE OR REPLACE FUNCTION public.log_brand_directory_access()
RETURNS void
LANGUAGE plpgsql
SECURITY DEFINER
SET search_path TO 'public'
...
CREATE OR REPLACE FUNCTION public.log_retailer_directory_access()
RETURNS void
LANGUAGE plpgsql
SECURITY DEFINER
SET search_path TO 'public'
