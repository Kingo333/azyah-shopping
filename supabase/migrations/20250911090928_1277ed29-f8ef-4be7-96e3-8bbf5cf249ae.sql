...
-- First, create the missing brand record for the existing brand user
...
ON CONFLICT (owner_user_id) DO NOTHING; -- Prevent duplicate if already exists
...
-- Ensure users can read brand data they own
CREATE POLICY "Brand owners can view their brands" 
