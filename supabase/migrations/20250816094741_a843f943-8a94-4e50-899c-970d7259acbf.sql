...
-- Only allow users to update their own profile data (with restrictions)
...
-- Allow aggregated queries only for trending data functions
CREATE POLICY "Allow trending data functions"
ON public.swipes
FOR SELECT
