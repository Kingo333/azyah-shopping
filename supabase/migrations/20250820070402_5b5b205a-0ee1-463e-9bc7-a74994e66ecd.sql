-- Fix subcategory enum issues and improve product deletion

-- First, add missing enum values that are causing errors
ALTER TYPE subcategory_type ADD VALUE IF NOT EXISTS 'fragrances';

-- Update NULL subcategories with appropriate defaults based on category
UPDATE products 
