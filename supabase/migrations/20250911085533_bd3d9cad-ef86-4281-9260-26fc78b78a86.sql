-- Complete user deletion for abdullahiking33@gmail.com
...
BEGIN
    ...
    FROM auth.users 
    WHERE email = 'abdullahiking33@gmail.com';
    
    -- If user exists, proceed with deletion
    IF target_user_id IS NOT NULL THEN
        RAISE NOTICE 'Found user % with ID %, proceeding with deletion', 'abdullahiking33@gmail.com', target_user_id;
        ...
        RAISE NOTICE 'Successfully deleted user % and all associated data', 'abdullahiking33@gmail.com';
    ELSE
        RAISE NOTICE 'User % not found in the system', 'abdullahiking33@gmail.com';
    END IF;
END $$;