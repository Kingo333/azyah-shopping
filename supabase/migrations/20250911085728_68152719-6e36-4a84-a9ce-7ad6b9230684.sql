-- Complete user deletion for abdullahiking33@gmail.com (Fixed version)
-- This will remove all user data to allow fresh signup

DO $$
DECLARE
    target_user_id uuid;
    target_email text := 'abdullahiking33@gmail.com';
BEGIN
    ...
    IF target_user_id IS NOT NULL THEN
        RAISE NOTICE 'Found user % with ID %, proceeding with deletion', target_email, target_user_id;
    ...
    ELSE
        RAISE NOTICE 'User % not found in the system', target_email;
    END IF;
END $$;