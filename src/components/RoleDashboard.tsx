...
import { QuickActionsCarousel } from '@/components/quick-actions/QuickActionsCarousel';
...
const RoleDashboard: React.FC = () => {
  ...
  const [toyReplicaModalOpen, setToyReplicaModalOpen] = useState(false);
  ...
  const handleToyReplicaClick = async () => {
    // Set toy replica section as selected and trigger modal
    setToyReplicaModalOpen(true);
  };
  ...
  const renderShopperDashboard = () => <div className="space-y-6">
      ...
      <QuickActionsCarousel 
        onAiStudioClick={() => setAiStudioModalOpen(true)}
        onToyReplicaClick={handleToyReplicaClick}
      />

      {/* Quick Actions Content Panel */}
      <QuickActionsPanel 
        aiStudioModalOpen={aiStudioModalOpen}
        setAiStudioModalOpen={setAiStudioModalOpen}
        toyReplicaModalOpen={toyReplicaModalOpen}
        setToyReplicaModalOpen={setToyReplicaModalOpen}
      />
