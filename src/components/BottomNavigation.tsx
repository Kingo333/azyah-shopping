...
import { Home, Compass, ShoppingBag, Users, ChevronUp } from 'lucide-react';
...
const navItems: NavItem[] = [
  ...
  { id: 'dressme', label: 'Closet', icon: HangerIcon, path: '/dress-me' },
                ...
                {navItems.map((item) => {
                  ...
                  if (item.isCenter) {
                    ...
                    return (
                      <button
                        ...
                        className="relative flex flex-col items-center justify-start h-full pt-1"
                      >
                  ...
                  return (
                    <button
                      key={item.id}
                      onClick={() => navigate(item.path)}
                      className={`flex flex-col items-center justify-start gap-1 pt-1.5 pb-0.5 px-2 transition-colors ${
                        active 
