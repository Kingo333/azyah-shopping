    ...
    <section className="px-4 pt-1">
      ...
      <div className="grid grid-cols-2 gap-1">
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-0.5 flex-1 max-h-[80px]">
            {/* Create Button - circular */}
            <div className="aspect-square flex items-center justify-center max-h-[38px]">
              <button 
                onClick={(e) => {
                  e.stopPropagation();
            ...
            {displayClosetItems.map((item) => (
              <div 
                key={item.id} 
                className="aspect-square rounded-md overflow-hidden bg-secondary/30 max-h-[38px]"
              >
                <img 
            ...
            {displayClosetItems.length < 3 && 
              Array.from({ length: 3 - displayClosetItems.length }).map((_, i) => (
                <div key={`empty-${i}`} className="aspect-square rounded-md bg-secondary/20 max-h-[38px]" />
              ))
            }
          </div>
        ...
        >
          ...
          <div className="relative rounded-md overflow-hidden bg-secondary/30 flex-1 max-h-[80px]">
