...
export const AiStudioHeader: React.FC<AiStudioHeaderProps> = ({
  ...
  return <div className="flex-shrink-0 p-3 md:p-4 border-b border-border/50 bg-background/95 backdrop-blur-sm">
      <DialogHeader>
        ...
        {!isPremium && <div className="mt-3 p-3 bg-gradient-to-r from-primary/10 to-accent/10 rounded-lg border border-primary/20">
            <div className="flex items-center gap-2">
              <Crown className="h-4 w-4 text-primary flex-shrink-0" />
              <div className="flex-1 min-w-0">
                <h4 className="text-sm font-semibold text-foreground">Upgrade to Premium</h4>
                <div className="text-xs text-muted-foreground">
                  More Daily Credits for Virtual Try-On and Beauty Guide • UGC collabs
                </div>
              </div>
