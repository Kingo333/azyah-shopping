...
export const FeatureShortcutTile: React.FC<FeatureShortcutTileProps> = ({
  ...
  return (
    <button
      onClick={onClick}
      className="flex flex-col items-center justify-center gap-1.5 md:gap-2 p-3 md:p-4 bg-card rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.08)] hover:shadow-[0_4px_12px_rgba(0,0,0,0.12)] transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] min-w-[64px] md:min-w-[90px] relative"
    >
      ...
      <div className="w-8 h-8 md:w-12 md:h-12 rounded-lg bg-secondary flex items-center justify-center">
        <Icon className="h-4 w-4 md:h-6 md:w-6 text-muted-foreground" />
      </div>
