...
const Swipe = () => {
  ...
  return <div className="min-h-screen dashboard-bg flex flex-col">
      ...
      <header className={`sticky top-0 z-50 w-full border-b border-white/20 glass-premium shrink-0 transition-opacity duration-300 ${isProductDetailOpen ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
        <div className="container max-w-screen-2xl mx-auto px-0 sm:px-1 py-0">
      ...
      {/* Main Content */}
      <main className="flex-1 flex flex-col container max-w-screen-lg mx-auto px-0 py-0">

        {/* Content Container */}
        {viewMode === 'swipe' ? <div className="flex-1 flex items-center justify-center min-h-[300px] px-0">
            <div className="relative w-full max-w-[380px] sm:max-w-md lg:max-w-lg h-[calc(100vh+10px)] lg:h-[calc(100vh+20px)] max-h-[1000px] lg:max-h-[1100px]">
              <SwipeDeck 
