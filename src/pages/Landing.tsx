...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* HERO */}
      <section id="discover" className="relative overflow-hidden min-h-screen bg-gradient-to-br from-background via-primary/5 to-gray-100">
        {/* Background Pattern */}
        <div className="absolute inset-0">
          <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_25%_25%,rgba(239,68,68,0.15),transparent_60%)]"/>
          <div className="absolute bottom-0 right-0 w-full h-full bg-[radial-gradient(circle_at_75%_75%,rgba(239,68,68,0.1),transparent_70%)]"/>
      ...
      <section className="py-24 lg:py-32 bg-gradient-to-b from-background to-gray-50">
      ...
      {/* QUALITY SECTION */}
      <section className="py-24 lg:py-32 bg-gradient-to-b from-gray-50 via-background to-primary/5">
        <div className="container max-w-7xl mx-auto px-6 lg:px-12">
      ...
      {/* FAQ SECTION */}
      <section id="faq" className="py-24 lg:py-32 bg-gradient-to-b from-primary/5 via-background to-primary/10">
