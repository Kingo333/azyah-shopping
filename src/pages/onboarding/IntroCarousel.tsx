...
const slides: SlideType[] = [{
  type: 'hero',
  image: '/onboarding/hero-visual-diverse-new.png',
          ...
          right: 0
            ...
            {slide.type === 'hero' && <div className="h-full flex flex-col">
                ...
                <div className="relative h-[55%] overflow-hidden">
                  <img src={slide.image} alt={slide.title} className="w-full h-full object-cover" style={{ objectPosition: 'center 35%' }} draggable={false} />
