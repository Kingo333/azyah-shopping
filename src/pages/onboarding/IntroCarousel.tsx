...
export default function IntroCarousel() {
  ...
  return <div className="h-screen bg-white flex flex-col overflow-hidden">
            ...
            {slide.type === 'gallery' && <div className="h-full flex flex-col px-6">
                ...
                <div className="flex-1 flex flex-col justify-start pt-2">
                  ...
                  <div className="overflow-x-auto flex gap-3 py-2 -mx-6 px-6 scrollbar-hide mb-4">
                    {[{
                  img: '/onboarding/intro-outfits.png',
                  label: 'Outfit Boards'
                }, {
                  ...
                  label: 'Rewards'
                }].map((item, idx) => <div key={idx} className="flex-shrink-0 w-36 rounded-xl overflow-hidden shadow-md">
      ...
      <div className="fixed bottom-0 left-0 right-0 px-3 pb-2 md:pb-3 pt-2 bg-gradient-to-t from-background via-background to-transparent z-20">
        {/* Navigation Dots */}
        <div className="gap-2 mb-4 md:mb-6 flex-row flex items-end justify-start">
