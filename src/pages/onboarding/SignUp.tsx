  ...
  return (
    ...
    >
      ...
      <div className="pt-2 pb-4 md:pt-4 md:pb-8 relative z-10 flex-shrink-0">
        <h1 className="text-3xl md:text-4xl font-bold text-white text-center tracking-tight" style={{ textShadow: '0 4px 12px rgba(0,0,0,0.8)' }}>
          Azyah
        </h1>
      </div>
        ...
        <div className="w-full max-w-md text-center space-y-6 md:space-y-8">
          ...
          <div className="space-y-3 md:space-y-4">
            {!isBrandOrRetailer && (
              <>
                <Button
                  ...
                  className="w-full h-12 md:h-14 text-sm md:text-base font-semibold rounded-full bg-white hover:bg-gray-50 text-gray-800 border-0 shadow-lg transition-all duration-200 hover:shadow-xl"
                >
                ...
                <Button
                  ...
                  className="w-full h-12 md:h-14 text-sm md:text-base font-semibold rounded-full bg-black hover:bg-gray-900 text-white border-0 shadow-lg transition-all duration-200 hover:shadow-xl"
                >
            ...
            <Button
              ...
              className="w-full h-12 md:h-14 text-sm md:text-base font-semibold rounded-full bg-white hover:bg-gray-50 text-gray-800 border border-gray-200 shadow-lg transition-all duration-200 hover:shadow-xl"
            >
